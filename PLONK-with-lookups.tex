...
Using randomness, we can reduce to the case of looking up single field elements instead of tuples. Then, in polynomial language, this ultimately boils down to proving polynomials are the same ``up to multiplicities''.
